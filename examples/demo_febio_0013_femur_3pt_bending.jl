...
# Fs,Vs = separate_vertices(F[indB],VT[stepStart+1])
...
hp5 = meshplot!(ax2, F[indB], VT[end]; strokewidth=1.0, color=S_Vs , colormap = :viridis, colorrange=(s1_min/30.0, s1_max/30.0))
